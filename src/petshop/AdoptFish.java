...
public class AdoptFish extends javax.swing.JFrame {
       ...
       try{                                                
           ...
           try{
            ...
            File dirl2 = null;
             ...
             String contents = simpleRead(br);
             
             
             String replacement = null;
             if(contents.contains(description.get(index))){
                 replacement = contents.replace(description.get(index), "#");
             }
    ...
    private String simpleRead(BufferedReader br){
        return br.lines().collect(Collectors.joining(System.lineSeparator()));
    }
        public void writeToFile(String file,String text) throws IOException{
        File dirl = new File("res/"+file+".txt");
        try{
             BufferedWriter out = new BufferedWriter(new FileWriter(dirl,false));
             out.write(text);
             out.close();
